...
import net.purwana.rads.workflow.shark.model.CustomDeadlinePersistenceObject;
import net.purwana.rads.workflow.shark.model.dao.DeadlineDao;
...
public class CustomWfActivityImpl extends WfActivityImpl {
    ...
    public void setHandleAllAssignments(WMSessionHandle shandle, boolean handleAllAssignments) throws Exception {
        if (handleAllAssignments) {
            this.set_priority(shandle, (short) 5); //since priority is not use in rads, use it to indicate multi approval
        }
