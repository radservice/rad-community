...
public class TestPluginManager {
    ...
    private String samplePluginFile = "../rad-plugins/rad-plugin-sample/target/rad-plugin-sample.jar";
    private String samplePlugin = "net.purwana.rads.plugin.sample.SamplePlugin";
    ...
    public void testLoadOsgiPlugin() {
        ...
        String reportPlugin = "net.purwana.rads.plugin.report.ReportPlugin";
    ...
    public void testLoadClassPlugin() {
        ...
        String pluginName = "net.purwana.rads.plugin.base.SampleApplicationPlugin";
