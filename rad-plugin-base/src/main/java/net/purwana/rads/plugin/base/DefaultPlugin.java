...
/**
 * Parent abstract class of net.purwana.rads.plugin.base.ExtDefaultPlugin
 * 
 * To develop a plugin, one must extends net.purwana.rads.plugin.base.ExtDefaultPlugin 
