package net.purwana.rads.plugin.enterprise;
...
public class CorporatiTheme extends UserviewTheme {
    ...
    public String getCss() {
        ...
        String cssPath = contextPath + "/plugin/net.purwana.rads.plugin.enterprise.CorporatiTheme/themes/corporati/corporati.css";
        ...
        if ("green".equals(colorScheme)) {
            String additionalCssPath = contextPath + "/plugin/net.purwana.rads.plugin.enterprise.CorporatiTheme/themes/corporati/corporatiGreen.css";
            String additionalCssLink = "<link rel='stylesheet' href='" + additionalCssPath + "'>";
            css += "</style>\n" + additionalCssLink;
        } else if ("blue".equals(colorScheme)) {
            String additionalCssPath = contextPath + "/plugin/net.purwana.rads.plugin.enterprise.CorporatiTheme/themes/corporati/corporatiBlue.css";
            String additionalCssLink = "<link rel='stylesheet' href='" + additionalCssPath + "'>";
            css += "</style>\n" + additionalCssLink;
        } else if ("red".equals(colorScheme)) {
            String additionalCssPath = contextPath + "/plugin/net.purwana.rads.plugin.enterprise.CorporatiTheme/themes/corporati/corporatiRed.css";
            String additionalCssLink = "<link rel='stylesheet' href='" + additionalCssPath + "'>";
            css += "</style>\n" + additionalCssLink;
        } else if ("yellow".equals(colorScheme)) {
            String additionalCssPath = contextPath + "/plugin/net.purwana.rads.plugin.enterprise.CorporatiTheme/themes/corporati/corporatiYellow.css";
            String additionalCssLink = "<link rel='stylesheet' href='" + additionalCssPath + "'>";
            css += "</style>\n" + additionalCssLink;
        }
