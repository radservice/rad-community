...
public class DatePicker extends Element implements FormBuilderPaletteElement, PwaOfflineResources {
    ...
    public String getFormBuilderTemplate() {
        return "<label class='label'>" + ResourceBundleUtil.getMessage("net.purwana.rads.apps.form.lib.DatePicker.pluginLabel") + "</label><input type='text' />";
    }
    ...
    public Set<String> getOfflineStaticResources() {
        ...
        urls.add(contextPath + "/plugin/net.purwana.rads.apps.form.lib.DatePicker/js/jquery.ui.datepicker-zh-CN.js");
        urls.add(contextPath + "/plugin/net.purwana.rads.apps.form.lib.DatePicker/js/jquery.placeholder.min.js");
        urls.add(contextPath + "/plugin/net.purwana.rads.apps.form.lib.DatePicker/css/datePicker.css");
        urls.add(contextPath + "/plugin/net.purwana.rads.apps.form.lib.DatePicker/css/jquery-ui-timepicker-addon.css");
        urls.add(contextPath + "/plugin/net.purwana.rads.apps.form.lib.DatePicker/js/jquery-ui-timepicker-addon.js");
