        ...
        if (file != null && !file.getOriginalFilename().isEmpty()) {
            ...
            if (appResource != null) { //replace
                ...
                if (isPublic != null && isPublic) {
                    ...
                    appResource.setPermissionClass("net.purwana.rads.apps.userview.lib.LoggedInUserPermission");
                    appResource.setPermissionProperties("{\"permission\": { \"className\": \"net.purwana.rads.apps.userview.lib.LoggedInUserPermission\", \"properties\": {}}}");
                }
