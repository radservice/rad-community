...
import net.purwana.rads.apps.userview.lib.DefaultV5EmptyTheme;
...
public class UserviewThemeProcesser {
    ...
    public String getHtml() {
        ...
        data.put("rads_header", getRADSHeader());
        ...
        data.put("rads_footer", getRADSFooter());
    ...
    protected String getRADSHeader() {
    ...
    protected String getRADSFooter() {
        String html = "";
