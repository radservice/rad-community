...
public class Radio extends SelectBox implements FormBuilderPaletteElement {
    ...
    public String getFormBuilderTemplate() {
        return "<label class='label'>" + ResourceBundleUtil.getMessage("net.purwana.rads.apps.form.lib.Radio.pluginLabel") + "</label><label><input type='radio' value='Option' style='color:silver' />" + ResourceBundleUtil.getMessage("form.checkbox.template.options") + "</label>";
    }
