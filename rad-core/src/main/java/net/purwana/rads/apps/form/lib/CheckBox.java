...
public class CheckBox extends SelectBox implements FormBuilderPaletteElement {
    ...
    public String getFormBuilderTemplate() {
        return "<label class='label'>" + ResourceBundleUtil.getMessage("net.purwana.rads.apps.form.lib.CheckBox.pluginLabel") + "</label><label><input type='checkbox' value='Option' style='color:silver' />" + ResourceBundleUtil.getMessage("form.checkbox.template.options") + "</label>";
    }
