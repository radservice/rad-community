...
public class SelectBox extends Element implements FormBuilderPaletteElement, FormAjaxOptionsElement, PwaOfflineValidation {
    ...
    public String getFormBuilderTemplate() {
        return "<label class='label'>" + ResourceBundleUtil.getMessage("net.purwana.rads.apps.form.lib.SelectBox.pluginLabel") + "</label><select><option>" + ResourceBundleUtil.getMessage("form.checkbox.template.options") + "</option></select>";
    }
