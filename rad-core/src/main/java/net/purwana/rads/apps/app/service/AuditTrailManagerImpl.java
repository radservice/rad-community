...
import net.purwana.rads.apps.app.dao.AuditTrailDao;
...
import net.purwana.rads.plugin.base.AuditTrailPlugin;
...
public class AuditTrailManagerImpl implements AuditTrailManager {
    ...
    protected boolean dbLog(AuditTrail auditTrail) {
        ...
        if (c != null && m != null) {
            //login info
            if (m.equals("authenticate") || m.equals("logout") || c.startsWith("net.purwana.rads.apps.app.") || c.startsWith("net.purwana.rads.directory.dao.") || c.endsWith("WorkflowManagerImpl") || c.endsWith("WorkflowToolActivityHandler") || c.endsWith("WorkflowAssignmentManager") || c.endsWith("PluginManager")) {
                return true;
            }
        }
