package net.purwana.rads.apps.app.service;
...
import net.purwana.rads.apps.app.model.CustomBuilderCallback;
...
import net.purwana.rads.apps.form.lib.LinkButton;
import net.purwana.rads.apps.form.lib.SaveAsDraftButton;
import net.purwana.rads.apps.form.lib.SubmitButton;
import net.purwana.rads.apps.form.lib.TextField;
import net.purwana.rads.apps.form.lib.WorkflowFormBinder;
import net.purwana.rads.apps.form.model.Column;
import net.purwana.rads.apps.form.model.Element;
import net.purwana.rads.apps.form.model.Form;
import net.purwana.rads.apps.form.model.FormAction;
...
import net.purwana.rads.commons.util.UuidGenerator;
...
import net.purwana.rads.workflow.model.WorkflowPackage;
...
import net.purwana.rads.workflow.model.dao.WorkflowProcessLinkDao;
...
import net.purwana.rads.workflow.shark.model.dao.WorkflowAssignmentDao;
...
//
    ...
    public void generatePO(String appId, String version, String locale, OutputStream output) throws IOException {
        ...
        try {
            writer.append("# This file was generated by RADS\r\n");
            writer.append("# http://rads.purwana.net\r\n");
            writer.append("msgid \"\"\r\n");
