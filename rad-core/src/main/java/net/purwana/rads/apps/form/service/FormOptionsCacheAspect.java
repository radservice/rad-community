...
public class FormOptionsCacheAspect {
    ...
    @Pointcut("execution(* net.purwana.rads.plugin.base.ExtDefaultPlugin.setProperties(..))")
    private void setPropertiesMethod() {
    }

    @Around("net.purwana.rads.apps.form.service.FormOptionsCacheAspect.setPropertiesMethod()")
    ...
    @Pointcut("execution(* net.purwana.rads.apps.form.model.FormLoadOptionsBinder.load(..))")
    private void loadMethod() {
    }

    @Around("net.purwana.rads.apps.form.service.FormOptionsCacheAspect.loadMethod()")
    ...
    @Pointcut("execution(* net.purwana.rads.apps.form.model.FormBinder.getPropertyOptions(..))")
    private void getPropertyOptionsMethod() {
    }

    @Around("net.purwana.rads.apps.form.service.FormOptionsCacheAspect.getPropertyOptionsMethod()")
