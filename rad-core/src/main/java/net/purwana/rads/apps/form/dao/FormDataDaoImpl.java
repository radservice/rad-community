package net.purwana.rads.apps.form.dao;
...
import net.purwana.rads.apps.form.model.FormColumnCache;
import net.purwana.rads.apps.form.model.FormContainer;
...
import static net.purwana.rads.commons.util.DynamicDataSourceManager.getProperties;
import net.purwana.rads.commons.util.HostManager;
import net.purwana.rads.commons.util.LogUtil;
import net.purwana.rads.commons.util.PluginThread;
...
public class FormDataDaoImpl extends HibernateDaoSupport implements FormDataDao {
    ...
    protected SessionFactory createSessionFactory(String entityName, String tableName, FormRowSet rowSet, int actionType) throws HibernateException {
        ...
        synchronized(this) {
            if (formRowDocument == null) {
                InputStream is = null;
                try {
                    is = Form.class.getResourceAsStream("/net/purwana/rads/apps/form/model/FormRow.hbm.xml");
     ...
     * @param columnList
     */
    protected void findAllElementIds(net.purwana.rads.apps.form.model.Element element, Collection<String> columnList) {
        ...
        if (!(element instanceof AbstractSubForm)) { // do not recurse into subforms
            Collection<net.purwana.rads.apps.form.model.Element> children = element.getChildren();
            if (children != null) {
                for (net.purwana.rads.apps.form.model.Element child : children) {
