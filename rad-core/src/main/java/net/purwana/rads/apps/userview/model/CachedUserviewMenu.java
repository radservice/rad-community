...
import net.purwana.rads.apps.userview.service.UserviewCache;
import net.purwana.rads.plugin.base.PluginProperty;
...
public class CachedUserviewMenu extends UserviewMenu {
     ...
     * If resource key not found, net.purwana.rads.plugin.property.model.PropertyEditable.getLabel()
     * will be use if the plugin also implemented net.purwana.rads.plugin.property.model.PropertyEditable
     ...
     * If resource key not found, value from net.purwana.rads.plugin.base.Plugin.getDescription() is use.
     ...
     *
     * @Deprecated Since version 3, RADS introduced a better UI for plugin
     * configuration. A plugin should implement net.purwana.rads.plugin.property.model.PropertyEditable
     ...
     * been moved to net.purwana.rads.plugin.base.DefaultApplicationPlugin
     *
