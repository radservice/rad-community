package net.purwana.rads.apps.generator.service;
...
import net.purwana.rads.apps.datalist.model.DataListBinder;
import static net.purwana.rads.apps.datalist.service.JsonUtil.parseBinderFromJsonObject;
...
import net.purwana.rads.apps.generator.model.GeneratorPlugin;
import net.purwana.rads.apps.userview.lib.RunProcess;
import net.purwana.rads.apps.userview.model.UserviewTheme;
...
import net.purwana.rads.plugin.enterprise.CorporatiTheme;
    ...
    public static String getFirstAvailableListIdByFormId(AppDefinition appDef, String formId) {
        ...
        if (list != null && !list.isEmpty()) {
            for (DatalistDefinition d : list) {
                ...
                if (json != null && !json.isEmpty()) {
                    if ((json.contains("net.purwana.rads.apps.datalist.lib.FormRowDataListBinder") || json.contains("net.purwana.rads.plugin.enterprise.AdvancedFormRowDataListBinder")) && json.contains(formId)) {
                        try {
                            // create json object
