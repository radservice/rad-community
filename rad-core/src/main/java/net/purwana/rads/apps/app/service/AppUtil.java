...
import net.purwana.rads.apps.app.lib.EmailTool;
import net.purwana.rads.apps.app.model.AppDefinition;
import net.purwana.rads.apps.app.model.HashVariablePlugin;
...
public class AppUtil implements ApplicationContextAware {
    ...
    static String designerContextPath = "/raddesigner";
...
/**
    ...
    protected static void attachIcal(final HtmlEmail email, Map properties, WorkflowAssignment wfAssignment, AppDefinition appDef) {
        try {
            if ("true".equalsIgnoreCase((String) properties.get("icsAttachement"))) {
                ...
                calendar.getProperties().add(new ProdId("-//RADS//iCal4j 1.0//EN"));
                ...
                UidGenerator ug = new FixedUidGenerator("rads-workflow");
    ...
    public static boolean isEnterprise() {
        try {
            Class.forName("net.purwana.rads.apps.license.LicenseManager");
            return true;
        } catch (Exception e) {}
