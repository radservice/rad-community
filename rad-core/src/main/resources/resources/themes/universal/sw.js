...
var FORM_DB_NAME         = 'rads' + '_' + appUserviewId;
var CACHE_DB_NAME         = 'rads-shared-cache';
...
self.addEventListener('fetch', function (event) {
    ...
    event.respondWith(
        fetch(fetchRequest)
        .then(function (response) {
            //redirect links eg. /rad/home, userview root url, are of response.type 'opaqueredirect', and possibly response.status != 200
            ...
            //but without this the top-right home button (/rad/home) will never be cached and will always show offline page when being accessed offline
