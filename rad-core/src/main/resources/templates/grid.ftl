...
<#if !(request.getAttribute("net.purwana.rads.apps.form.lib.Grid")??) >
    <script type="text/javascript" src="${request.contextPath}/js/jquery/jquery.jeditable.js"></script>
    <script type="text/javascript" src="${request.contextPath}/plugin/net.purwana.rads.apps.form.lib.Grid/js/jquery.formgrid.js"></script>
    <style type="text/css">
        .cgrid table {
            width: 100%;
        }
