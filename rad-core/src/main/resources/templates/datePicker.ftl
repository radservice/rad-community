...
<#if element.properties.readonly! != 'true'>
    <#if !(request.getAttribute("net.purwana.rads.apps.form.lib.DatePicker_EDITABLE")??)>
        <#if locale! != ''>
            <script type="text/javascript" src="${request.contextPath}/js/jquery/ui/i18n/jquery.ui.datepicker-${locale}.js"></script>
        </#if>
        <script type="text/javascript" src="${request.contextPath}/plugin/net.purwana.rads.apps.form.lib.DatePicker/js/jquery.placeholder.min.js"></script>
        <link rel="stylesheet" href="${request.contextPath}/plugin/net.purwana.rads.apps.form.lib.DatePicker/css/datePicker.css" />
        <link rel="stylesheet" href="${request.contextPath}/plugin/net.purwana.rads.apps.form.lib.DatePicker/css/jquery-ui-timepicker-addon.css" />
        <script type="text/javascript" src="${request.contextPath}/plugin/net.purwana.rads.apps.form.lib.DatePicker/js/jquery-ui-timepicker-addon.js"></script>
    </#if>
