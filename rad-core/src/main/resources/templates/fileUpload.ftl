<div class="form-cell" ${elementMetaData!}>
    <#if !(request.getAttribute("net.purwana.rads.apps.form.lib.FileUpload")?? || request.getAttribute("net.purwana.rads.plugin.enterprise.ImageUpload")??)  >
        ...
        <script src="${request.contextPath}/plugin/net.purwana.rads.apps.form.lib.FileUpload/js/jquery.fileupload.js"></script>
