...
public class TestHashVariable {
    ...
    public static String separated = "RADS.;<ABC> Inc.;Jack & Co.";
    public static String nl2br = "RADS.\n<ABC> Inc.\nJack & Co.";
    ...
    public void testEscape() {
        ...
        Assert.assertEquals("RADS.; Inc.;Jack &amp; Co.", AppUtil.processHashVariable("#envVariable.separated#", null, null, null));
        Assert.assertEquals("RADS.  Inc. Jack &amp; Co.", AppUtil.processHashVariable("#envVariable.nl2br#", null, null, null));
    }
    ...
    public void testEscapeWithFormat() {
        Assert.assertEquals("RADS.,  Inc., Jack &amp; Co.", AppUtil.processHashVariable("#envVariable.separated?separator(, )#", null, null, null));
        Assert.assertEquals("RADS.<br class=\"nl2br\" /> Inc.<br class=\"nl2br\" />Jack &amp; Co.", AppUtil.processHashVariable("#envVariable.nl2br?nl2br#", null, null, null));
    }
    
    @Test
    public void testNoEscapeWithFormat() {
        Assert.assertEquals("RADS., <ABC> Inc., Jack & Co.", AppUtil.processHashVariable("#envVariable.separated?separator(, );java#", null, null, null));
        Assert.assertEquals("RADS., <ABC> Inc., Jack & Co.", AppUtil.processHashVariable("#envVariable.separated?separator(, );noescape#", null, null, null));
        Assert.assertEquals("RADS., &lt;ABC&gt; Inc., Jack &amp; Co.", AppUtil.processHashVariable("#envVariable.separated?separator(, );html#", null, null, null));
        Assert.assertEquals("RADS.<br class=\\\"nl2br\\\" /><ABC> Inc.<br class=\\\"nl2br\\\" />Jack & Co.", AppUtil.processHashVariable("#envVariable.nl2br?nl2br;java#", null, null, null));
        Assert.assertEquals("RADS.<br class=\"nl2br\" /><ABC> Inc.<br class=\"nl2br\" />Jack & Co.", AppUtil.processHashVariable("#envVariable.nl2br?nl2br;noescape#", null, null, null));
        Assert.assertEquals("RADS.<br class=\"nl2br\" />&lt;ABC&gt; Inc.<br class=\"nl2br\" />Jack &amp; Co.", AppUtil.processHashVariable("#envVariable.nl2br?html;nl2br#", null, null, null));
    }
