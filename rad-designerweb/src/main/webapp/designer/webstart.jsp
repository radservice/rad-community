...
<jnlp codebase="${serverPath}/webstart">
    <information>
        ...
        <vendor>rads.purwana.net</vendor>
        <homepage href="http://rads.purwana.net/"/>
        <description>rads.purwana.net wfdesigner</description>
        <offline-allowed/>
    ...
    <resources>
        <j2se version="1.5+"/>
        <jar href="rad-designer-${project.version}.jar" main="true"/>
    ...
    <application-desc main-class="net.purwana.rads.designer.Designer">
