package net.purwana.rads.apps.ext;
...
public class ConsoleWebPlugin extends ExtDefaultPlugin implements PluginWebSupport {
    ...
    public String getFooter(String path) {
        ...
        String footer = "&copy; <a href=\"https://rads.purwana.net\" target=\"_blank\">RADS</a>. " + revision;
        return footer;
    }
    ...
    protected String getWelcome() {
        String content = "<div id=\"getting-started\">"
                ...
                + "</div>"
                + "<div class=\"clear\"></div>"
                + "<script>$(window).on(\"load\", function() { $(\"#welcomeFrame\").attr(\"src\", \"https://rads.purwana.net/welcome-community\"); });</script>";
        return content;
    }
