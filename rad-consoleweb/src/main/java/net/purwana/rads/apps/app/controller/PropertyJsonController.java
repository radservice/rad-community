...
import net.purwana.rads.plugin.base.CustomPluginInterface;
...
public class PropertyJsonController {
    ...
    public void getProperties(HttpServletRequest request, Writer writer, @RequestParam("value") String value) throws Exception {
        ...
        if (element != null 
                && callReference != null
                && (callReference.contains("classname=net.purwana.rads.apps.form.model.FormLoadElementBinder")
                    || callReference.contains("classname=net.purwana.rads.apps.form.model.FormStoreElementBinder")
                    || callReference.contains("classname=net.purwana.rads.apps.form.model.FormLoadMultiRowElementBinder")
                    || callReference.contains("classname=net.purwana.rads.apps.form.model.FormStoreMultiRowElementBinder")) 
