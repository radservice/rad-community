...
import net.purwana.rads.apps.datalist.service.DataListDecorator;
...
public class FormListDataJsonController {
     ...
     * curl -v -X POST -d "j_username=admin&j_password=admin" http://localhost:8080/rad/web/json/data/form/load/crm/crm_account/001
     * @param writer
     * @param response
     * @param appId
     * @param formId
     ...
     * curl -v -X POST -d "j_username=admin&j_password=admin&accountName=001%Updated&address=001%20Address" http://localhost:8080/rad/web/json/data/form/store/crm//crm_account/001
     * curl -v --header "Authorization: Basic YWRtaW46YWRtaW4=" -F "accountName=001 Updated" -F "address=001 Address" http://localhost:8080/rad/web/json/data/form/store/crm//crm_account/001
     * @param writer
     * @param request
     * @param response
     * @param appId
     ...
     * curl -v -X POST -d "j_username=admin&j_password=admin" http://localhost:8080/rad/web/json/data/form/delete/crm//crm_account/001
     * @param writer
     * @param request
     * @param response
     * @param appId
     ...
     * curl -v -d "j_username=admin&j_password=admin" http://localhost:8080/rad/web/json/data/list/crm/crm_account_list
     * @param writer
     * @param response
     * @param appId
     * @param listId
