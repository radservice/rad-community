package net.purwana.rads.apps.app.controller;
...
import net.purwana.rads.apps.app.dao.AppDefinitionDao;
import net.purwana.rads.apps.app.dao.AppResourceDao;
import net.purwana.rads.apps.app.dao.BuilderDefinitionDao;
import net.purwana.rads.apps.app.dao.EnvironmentVariableDao;
import net.purwana.rads.apps.app.dao.FormDefinitionDao;
import net.purwana.rads.apps.app.dao.MessageDao;
import net.purwana.rads.apps.app.dao.PackageDefinitionDao;
import net.purwana.rads.apps.app.dao.PluginDefaultPropertiesDao;
import net.purwana.rads.apps.app.dao.UserviewDefinitionDao;
import net.purwana.rads.apps.app.dao.DatalistDefinitionDao;
...
import net.purwana.rads.apps.app.model.CustomBuilder;
import net.purwana.rads.apps.app.model.EnvironmentVariable;
import net.purwana.rads.apps.app.model.FormDefinition;
import net.purwana.rads.apps.app.model.Message;
import net.purwana.rads.apps.app.model.PackageActivityForm;
import net.purwana.rads.apps.app.model.PackageActivityPlugin;
import net.purwana.rads.apps.app.model.PackageDefinition;
import net.purwana.rads.apps.app.model.PackageParticipant;
...
import net.purwana.rads.apps.app.model.ImportAppException;
import net.purwana.rads.apps.app.model.ProcessMappingInfo;
import net.purwana.rads.apps.app.model.ProcessFormModifier;
import net.purwana.rads.apps.app.model.StartProcessFormModifier;
import net.purwana.rads.apps.app.service.AppDevUtil;
import net.purwana.rads.apps.app.service.AppPluginUtil;
import net.purwana.rads.apps.app.service.AppResourceUtil;
import net.purwana.rads.apps.app.service.AppService;
import net.purwana.rads.apps.app.service.AppUtil;
import net.purwana.rads.apps.app.service.AuditTrailManager;
import net.purwana.rads.apps.app.service.CustomBuilderUtil;
import net.purwana.rads.apps.app.service.PushServiceUtil;
import net.purwana.rads.apps.app.service.TaggingUtil;
import net.purwana.rads.apps.datalist.service.DataListService;
import net.purwana.rads.apps.datalist.service.JsonUtil;
import net.purwana.rads.apps.ext.ConsoleWebPlugin;
import net.purwana.rads.apps.form.dao.FormDataDao;
import net.purwana.rads.apps.form.lib.DefaultFormBinder;
import net.purwana.rads.apps.form.model.Form;
import net.purwana.rads.apps.form.service.CustomFormDataTableUtil;
import net.purwana.rads.apps.form.service.FormService;
import net.purwana.rads.apps.form.service.FormUtil;
import net.purwana.rads.apps.generator.service.GeneratorUtil;
import net.purwana.rads.apps.userview.service.UserviewService;
import net.purwana.rads.apps.workflow.security.EnhancedWorkflowUserManager;
import net.purwana.rads.commons.spring.model.ResourceBundleMessage;
import net.purwana.rads.commons.spring.model.ResourceBundleMessageDao;
import net.purwana.rads.commons.spring.model.Setting;
import net.purwana.rads.commons.util.TimeZoneUtil;
...
import net.purwana.rads.plugin.base.Plugin;
import net.purwana.rads.plugin.base.PluginManager;
import net.purwana.rads.workflow.model.WorkflowActivity;
import net.purwana.rads.workflow.model.WorkflowParticipant;
import net.purwana.rads.workflow.model.WorkflowProcess;
import net.purwana.rads.workflow.model.WorkflowVariable;
import net.purwana.rads.commons.util.CsvUtil;
import net.purwana.rads.commons.util.DateUtil;
import net.purwana.rads.commons.util.DynamicDataSourceManager;
import net.purwana.rads.commons.util.FileLimitException;
import net.purwana.rads.commons.util.FileStore;
import net.purwana.rads.commons.util.HostManager;
import net.purwana.rads.commons.util.LogUtil;
import net.purwana.rads.commons.util.PagingUtils;
import net.purwana.rads.commons.util.ResourceBundleUtil;
import net.purwana.rads.commons.util.SecurityUtil;
import net.purwana.rads.commons.util.SetupManager;
import net.purwana.rads.commons.util.StringUtil;
import net.purwana.rads.directory.dao.DepartmentDao;
import net.purwana.rads.directory.dao.EmploymentDao;
import net.purwana.rads.directory.dao.GradeDao;
import net.purwana.rads.directory.dao.GroupDao;
import net.purwana.rads.directory.dao.OrganizationDao;
import net.purwana.rads.directory.dao.RoleDao;
import net.purwana.rads.directory.dao.UserDao;
import net.purwana.rads.directory.dao.UserMetaDataDao;
import net.purwana.rads.directory.model.Grade;
import net.purwana.rads.directory.model.Organization;
import net.purwana.rads.directory.model.service.DirectoryManagerPlugin;
import net.purwana.rads.directory.model.service.DirectoryUtil;
import net.purwana.rads.directory.model.service.UserSecurity;
import net.purwana.rads.logs.LogViewerAppender;
...
import net.purwana.rads.workflow.model.WorkflowProcessLink;
...
public class ConsoleWebController {
    ...
    public void getPackageXpdl(Writer writer, HttpServletResponse response, @RequestParam(value = "appId") String appId, @RequestParam(value = "version", required = false) String version) throws IOException {
        ...
        if (packageDef != null) {
            ...
            try {
                ...
                String url = "/net/purwana/rads/apps/app/model/default.xpdl";
    ...
    public String consoleActivityFormPlugin(ModelMap map, @RequestParam("appId") String appId, @RequestParam(required = false) String version, @RequestParam String processDefId, @RequestParam String activityDefId) throws UnsupportedEncodingException {
        ...
        if (WorkflowUtil.ACTIVITY_DEF_ID_RUN_PROCESS.equals(activityDefId)) {
            map.addAttribute("pluginClass", "net.purwana.rads.apps.app.model.StartProcessFormModifier");
        } else {
            map.addAttribute("pluginClass", "net.purwana.rads.apps.app.model.ProcessFormModifier");
        }
...
//        }
    ...
    protected Map<String, String> getPluginTypeForDefaultProperty() {
        ...
        pluginTypeMap.put("net.purwana.rads.plugin.base.AuditTrailPlugin", ResourceBundleUtil.getMessage("setting.plugin.auditTrail"));
        pluginTypeMap.put("net.purwana.rads.workflow.model.DeadlinePlugin", ResourceBundleUtil.getMessage("setting.plugin.deadline"));
        pluginTypeMap.put("net.purwana.rads.workflow.model.ParticipantPlugin", ResourceBundleUtil.getMessage("setting.plugin.processParticipant"));
        pluginTypeMap.put("net.purwana.rads.plugin.base.ApplicationPlugin", ResourceBundleUtil.getMessage("setting.plugin.processTool"));
        pluginTypeMap.put("net.purwana.rads.apps.app.model.ProcessFormModifier", ResourceBundleUtil.getMessage("setting.plugin.processFormModifier"));
