DatalistBuilder = {
        ...
        return [
            {title: get_dbuilder_msg('dbuilder.selectBinder'),
                ...
                properties : [{
                    ...
                    type : 'elementselect',
                    options_ajax : '[CONTEXT_PATH]/web/property/json/getElements?classname=net.purwana.rads.apps.datalist.model.DataListBinder',
    ...
    initFormatterList : function(deferreds){
        ...
        $.getJSON(
            DatalistBuilder.contextPath + '/web/property/json/getElements?classname=net.purwana.rads.apps.datalist.model.DataListColumnFormat',
            function(returnedData){
            ...
            stop: function(event, ui){
                ...
                if($(ui.item[0]).hasClass("builder-palette-column")){
                    ...
                    DatalistBuilder.chosenFilters[columnId].type = {
                        "className" : "net.purwana.rads.apps.datalist.lib.TextFieldDataListFilterType",
                        "properties" : {}
                    };
    ...
    getColumnPropertiesDefinition : function() {
        return [{
            ...
            properties :[
            {
                ...
                type : 'elementselect',
                options_ajax : '[CONTEXT_PATH]/web/property/json/getElements?classname=net.purwana.rads.apps.datalist.model.DataListColumnFormat',
                url : '[CONTEXT_PATH]/web/property/json' + DatalistBuilder.appPath + '/getPropertyOptions'
            }]
        }];
    },
    ...
    getFilterPropertiesDefinition : function () {
        return [{
            ...
            },
            {
                ...
                type : 'elementselect',
                value : 'net.purwana.rads.apps.datalist.lib.TextFieldDataListFilterType',
                options_ajax : '[CONTEXT_PATH]/web/property/json/getElements?classname=net.purwana.rads.apps.datalist.model.DataListFilterType',
                url : '[CONTEXT_PATH]/web/property/json' + DatalistBuilder.appPath + '/getPropertyOptions'
            },
            {
