PermissionManager = {
    ...
    init : function (container, json, options) {
        ...
        if (PermissionManager.permissionPlugins === null) {
            ...
            if (PermissionManager.options.builder === "form") {
                className = "net.purwana.rads.apps.form.model.FormPermission";
            } else if (PermissionManager.options.builder === "userview") {
                className = "net.purwana.rads.apps.userview.model.UserviewAccessPermission";
            } else if (PermissionManager.options.builder === "datalist") {
                className = "net.purwana.rads.apps.datalist.model.DatalistPermission";
    ...
    getElementPluginLabel : function(element) {
        if (PermissionManager.options.builder === "form") {
            ...
            if (classname === "net.purwana.rads.apps.form.model.Section") {
            ...
            var classname = element["className"];
            if (classname === "net.purwana.rads.apps.userview.model.UserviewCategory") {
    ...
    isIgnoreRendering : function(element) {
        if (PermissionManager.options.builder === "form") {
            if (element["className"] === "net.purwana.rads.apps.form.model.Form" 
                    || element["className"] === "net.purwana.rads.apps.form.model.Column") {
                return true;
            } else {
                return false;
            }
        } else if (PermissionManager.options.builder === "userview") {
            if (element["className"] === "net.purwana.rads.apps.userview.model.Userview") {
                return true;
            } else {
                return false;
            }
    ...
    isElementSupportPlugin : function(element) {
        if (PermissionManager.options.builder === "form") {
            if (element["className"] === "net.purwana.rads.apps.form.model.Section") {
                return true;
            } else {
                return false;
            }
        } else if (PermissionManager.options.builder === "userview") {
            if (element["className"] === "net.purwana.rads.apps.userview.model.UserviewCategory") {
                return true;
            } else {
                return false;
            }
