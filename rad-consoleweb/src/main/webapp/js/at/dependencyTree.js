$.jstree.plugins.rads = function (options, parent) {
...
DependencyTree.Util = {
    ...
    addIndicator: function (viewer, node, icon, label, color, callback, slash) {
        ...
        if (icon.indexOf("pwaoffline") !== -1) {
            ...
            if (!(node.data["className"] === "net.purwana.rads.apps.userview.model.Userview" 
                    || node.data["className"] === "net.purwana.rads.apps.userview.model.UserviewCategory")) {
        ...
        'properties' : {
            match : function (viewer, deferreds, node, jsonObj, refObj) {
                if (jsonObj['properties'] !== undefined && !$.isEmptyObject(jsonObj['properties'])) {
                    ...
                    if (node.data['className'] === "net.purwana.rads.apps.form.model.Form" 
                            || node.data['className'] === "net.purwana.rads.apps.form.model.Section" 
                            || node.data['className'] === "net.purwana.rads.apps.form.model.Column"
...
DependencyTree.Matchers['formElement'] = {
    ...
    matchers : {
        'editable' : {
            match : function (viewer, deferreds, node, jsonObj, refObj) {
                if (jsonObj['className'] === "net.purwana.rads.apps.form.model.Form") {
        ...
        'hasCustomLoadBinder' : {
            match : function (viewer, deferreds, node, jsonObj, refObj) {
                if (jsonObj['properties']['loadBinder'] !== undefined && jsonObj['properties']['loadBinder']['className'] !== "" && jsonObj['properties']['loadBinder']['className'] !== "net.purwana.rads.apps.form.lib.WorkflowFormBinder") {
        ...
        'hasCustomStoreBinder' : {
            match : function (viewer, deferreds, node, jsonObj, refObj) {
                if (jsonObj['properties']['storeBinder'] !== undefined && jsonObj['properties']['storeBinder']['className'] !== "" && jsonObj['properties']['storeBinder']['className'] !== "net.purwana.rads.apps.form.lib.WorkflowFormBinder") {
        ...
        'hasPostProcessor' : {
            match : function (viewer, deferreds, node, jsonObj, refObj) {
                if (jsonObj['properties']['postProcessor'] !== undefined && jsonObj['properties']['postProcessor']['className'] !== "" && jsonObj['properties']['postProcessor']['className'] !== "net.purwana.rads.apps.form.lib.WorkflowFormBinder") {
...
DependencyTree.Matchers['userview'] = {
    match : function (viewer, deferreds, node, jsonObj, refObj) {
        if (jsonObj['className'] !== undefined && jsonObj['className'] === "net.purwana.rads.apps.userview.model.Userview") {
...
DependencyTree.Matchers['userviewCategory'] = {
    match : function (viewer, deferreds, node, jsonObj, refObj) {
        if (jsonObj['className'] !== undefined && jsonObj['className'] === "net.purwana.rads.apps.userview.model.UserviewCategory") {
...
DependencyTree.Viewer.prototype = {
    init : function() {
        ...
        if (!this.isInit) {
            ...
            deferreds.push(pl);
            $.ajax({
                url: viewer.options.contextPath + '/web/property/json/getElements?classname=net.purwana.rads.plugin.property.model.PropertyEditable&includeHidden=true&pwaValidation=true',
                dataType : "json",
                success: function(response) {
                    viewer.pluginList = {};
