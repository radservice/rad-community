I18nEditor = {
    ...
    retrieveTooltipLabels : function(labels, jsonObj) {
        if (jsonObj.className !== "" &&
                jsonObj.className !== "net.purwana.rads.apps.form.model.Form" &&
                jsonObj.className !== "net.purwana.rads.apps.form.model.Section" && 
                jsonObj.className !== "net.purwana.rads.apps.form.model.Column") {
