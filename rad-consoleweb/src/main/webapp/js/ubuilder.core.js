UserviewBuilder = {
    ...
    initDefaultUserviewDataModel : function(id){
        var d = new Object();
        d['className'] = "net.purwana.rads.apps.userview.model.Userview";
        ...
        d.properties['footerMessage'] = "Powered by RADS.",
        d['setting'] = new Object();
        d.setting['className'] = "net.purwana.rads.apps.userview.model.UserviewSetting";
    ...
    initBuilder : function(){
        ...
        if(UserviewBuilder.data.setting == undefined){
            ...
            UserviewBuilder.data.setting['className'] = "net.purwana.rads.apps.userview.model.UserviewSetting";
    ...
    addCategory : function(element, copiedCategory){
        ...
        if (copiedCategory !== undefined && copiedCategory !== null) {
            ...
            category['className'] = "net.purwana.rads.apps.userview.model.UserviewCategory";
