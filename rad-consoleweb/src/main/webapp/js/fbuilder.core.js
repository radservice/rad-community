FormBuilder = {
    ...
    refreshElementTemplate: function(element) {
        ...
        if (elementClass != 'net.purwana.rads.apps.form.model.Section' && elementClass != 'net.purwana.rads.apps.form.model.Column') {
            FormBuilder.unloadElement(element);
            $(element).html(elementHtml);
        } else if (elementClass == 'net.purwana.rads.apps.form.model.Column') {
    ...
    retrieveElementHTML: function(element, dom, elementClass, elementProperty, callback) {
        ...
        if (elementClass == 'net.purwana.rads.apps.form.model.Section') {
    ...
    addSection: function(parent, position) {
        // add a new section
        var section = $("<div class='form-section' element-class='net.purwana.rads.apps.form.model.Section' element-property='{label:\""+get_fbuilder_msg("fbuilder.section")+"\"}'></div>");
    ...
    addColumn: function(section, initSectionsAndColumns) {
        // add a new column
        var column = $("<div class='form-column' element-class='net.purwana.rads.apps.form.model.Column'></div>");
    ...
    generateJSON: function(triggerChange) {
        var form = new Object();
        form.className = "net.purwana.rads.apps.form.model.Form";
...
//        }
        var formOptions = FormBuilder.elementPropertyDefinitions["net.purwana.rads.apps.form.model.Form"];
