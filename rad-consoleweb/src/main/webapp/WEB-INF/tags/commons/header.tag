...
<%@ tag import="net.purwana.rads.directory.model.service.DirectoryUtil"%>
<%@ tag import="net.purwana.rads.workflow.util.WorkflowUtil"%>
<%@ tag import="net.purwana.rads.commons.util.LogUtil"%>
<%@ tag import="net.purwana.rads.commons.util.HostManager"%>
    ...
    <body id="${bodyId}">
        <div id="main-header">
            <a id="home-link" href="${pageContext.request.contextPath}/">
                <span id="logo"></span>
                <span id="logo-title"><jsp:include page="/web/json/plugin/net.purwana.rads.apps.ext.ConsoleWebPlugin/service?spot=header" /></span>
            </a>
            <div id="header-links">
