...
<%@ page import="java.io.File,net.purwana.rads.commons.util.SetupManager"%>
<%@ page import="net.purwana.rads.commons.util.HostManager"%>
...
<div id="main">
    ...
    <div id="main-body">
        <div id="generalSetup">
            ...
            <jsp:include page="/web/json/plugin/net.purwana.rads.apps.ext.ConsoleWebPlugin/service?spot=settings" />
...
<script>
    //masterLoginHash
    var loginHashDeliminator = '<%= net.purwana.rads.directory.model.User.LOGIN_HASH_DELIMINATOR %>';
