...
<jsp:useBean id="PropertyUtil" class="net.purwana.rads.plugin.property.service.PropertyUtil" scope="page"/>
            ...
            var options = {
                ...
                propertiesDefinition : [{
                    ...
                    { 
                        ...
                        type : 'elementselect',
                        options_ajax : '[CONTEXT_PATH]/web/property/json/getElements?classname=net.purwana.rads.apps.userview.model.UserviewPermission',
