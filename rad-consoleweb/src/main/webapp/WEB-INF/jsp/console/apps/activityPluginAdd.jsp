...
<commons:popupHeader />
    ...
    <div id="main-body-content" style="text-align: left">
        <ui:jsontable url="${pageContext.request.contextPath}/web/json/plugin/list?className=net.purwana.rads.plugin.base.ApplicationPlugin&${pageContext.request.queryString}"
                       var="JsonDataTable"
