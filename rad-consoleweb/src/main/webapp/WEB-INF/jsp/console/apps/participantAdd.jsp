    ...
    <div id="main-body-content" style="text-align: left">
        <div id="userTabView">
            ...
            <div>
                ...
                <div id="plugin">
                    <br/>
                    <ui:jsontable url="${pageContext.request.contextPath}/web/json/plugin/list?className=net.purwana.rads.workflow.model.ParticipantPlugin&${pageContext.request.queryString}"
