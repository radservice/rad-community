...
<%@ page import="net.purwana.rads.apps.datalist.model.DataList"%>
<%@ page import="net.purwana.rads.apps.datalist.model.DataListColumn"%>
<%@ page import="net.purwana.rads.apps.datalist.model.DataListColumnFormat"%>
<%@ page import="net.purwana.rads.commons.util.StringUtil"%>
