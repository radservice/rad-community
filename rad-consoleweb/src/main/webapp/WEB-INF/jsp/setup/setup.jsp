...
<%@page import="net.purwana.rads.commons.util.*"%>
                        ...
                        <form id="setupForm" method="post" action="${pageContext.request.contextPath}/web/console/setting/datasource/submit">
                            ...
                            <div id="dbSetup" class="main-row-content">
                                ...
                                <div class="form-row">
                                    ...
                                    <span class="form-input">
                                        <input type="text" size="40" id="dbName" name="dbName" value="radsdb"/>
                                    </span>
                                </div>
                                <div class="form-row">
                            ...
                            <div id="jdbcSetup" class="main-row-content">
                                ...
                                <div class="form-row">
                                    ...
                                    <span class="form-input">
                                        <input type="text" size="40" id="jdbcUrl" name="jdbcUrl" value="jdbc:mysql://localhost:3306/radsdb?characterEncoding=UTF-8&amp;useSSL=false&amp;allowPublicKeyRetrieval=true"/>
