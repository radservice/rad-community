...
<style>
    ...
    .viewForm-body-message button{
        ...
        background:url("${requestParameters.contextPath}/plugin/net.purwana.rads.apps.userview.lib.viewForm/images/dropdown_btn_bg.gif") repeat-x scroll 0 0 #E7FAB6;
    }
    .viewForm-body-message button {
        border: 1px solid #799837;
        ...
        padding: 4px 10px;
        background: #e7fab6 url("${requestParameters.contextPath}/plugin/net.purwana.rads.apps.userview.lib.viewForm/images/dropdown_btn_bg_hover.gif") 0 0 repeat-x;
        font-size: 12px;
        color: #565656;
        cursor: pointer;
        border-radius: 4px; }
    .viewForm-body-message button:hover {
        background: #e7fab6 url("${requestParameters.contextPath}/plugin/net.purwana.rads.apps.userview.lib.viewForm/images/dropdown_btn_bg.gif") 0 0 repeat-x;
    }
</style>
