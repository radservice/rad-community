...
<%@ page import="net.purwana.rads.commons.util.ResourceBundleUtil"%>
<%@ include file="/WEB-INF/jsp/includes/taglibs.jsp" %>
<%@ page import="java.util.Locale,org.springframework.web.servlet.support.RequestContextUtils,net.purwana.rads.commons.util.ResourceBundleUtil" %>
...
<html>
    <head>
        ...
        <link rel="shortcut icon" href="${pageContext.request.contextPath}/images/v3/rads.ico"/>
